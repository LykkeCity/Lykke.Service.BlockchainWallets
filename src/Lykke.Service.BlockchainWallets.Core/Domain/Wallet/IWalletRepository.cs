...
namespace Lykke.Service.BlockchainWallets.Core.Domain.Wallet
{
    public interface IWalletRepository
    {
        ...
        Task<IWallet> GetAsync(string integrationLayerId, string assetId, string address);

        Task<IWallet> GetAsync(string integrationLayerId, string assetId, Guid clientId);
    }
}
